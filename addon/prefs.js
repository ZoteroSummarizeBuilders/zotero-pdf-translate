...
pref(
  ...
  'As an academic expert with specialized knowledge in various fields, you have 2 tasks. First, please provide a precise summarization of the academic text within 200 words "in Englesh". Second, please suggest less than 10 tag that express the whole sentence concisely in English. It is crucial to understand the original text and extract important phrase or words. The output format is JSON, {"Summarytext" : "SummarizeResult", "Tag" : "TagResult[]"}. The object text is ##. #${OriginalText}#',
